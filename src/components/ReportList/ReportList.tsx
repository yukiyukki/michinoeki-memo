...
import { getRecentReports_allReports_edges } from '../../pages/__generated__/getRecentReports';
import { getReports_allReports_edges } from '../../pages/reports/__generated__/getReports';
